...
public class Circuled {
	...
	public Circuled(int[][][] preference, int prefere[][], int N, String blocking_pairs) {
 ...
 int prefere_temp[][] = new int[2 * N][N];
	...
	public void Circuled_algorithm() {
		...
		catch(Exception e)
		{
			...
			Preference_Matrix.numClicks_circuled --;		
		}
		finally
		{
		...
		if(result == false)
		{
			System.out.println("\n\nCirculed Algortihm solution is stable. :)))))))))\n\n");
		 ...
		 //SEM
			...
			//circuled
			double circuled_sum =0;
			for(int ii = 0; ii< N ; ii ++)
			{
				circuled_sum= circuled_sum + Math.abs(preference[ii][evliler[ii]-N][0] + preference[ii][evliler[ii]-N][1]);
				 
				
			}
			
			Preference_Matrix.sonuc_ortalamalari_circuled  [0][0]=Preference_Matrix.sonuc_ortalamalari_circuled  [0][0]+ (double) (worstcase1) ;
			Preference_Matrix.sonuc_ortalamalari_circuled  [1][0]=Preference_Matrix.sonuc_ortalamalari_circuled  [1][0]+(double) (worstcase2) ;
			Preference_Matrix.sonuc_ortalamalari_circuled  [0][1]=Preference_Matrix.sonuc_ortalamalari_circuled  [0][1]+ (double) (bestcase1) ;
			Preference_Matrix.sonuc_ortalamalari_circuled  [1][1]=Preference_Matrix.sonuc_ortalamalari_circuled  [1][1]+(double) (bestcase2 );
			Preference_Matrix.sonuc_ortalamalari_circuled  [0][2]=Preference_Matrix.sonuc_ortalamalari_circuled  [0][2]+(double) (aritmetik_ortalama1 );
			Preference_Matrix.sonuc_ortalamalari_circuled  [1][2]=Preference_Matrix.sonuc_ortalamalari_circuled  [1][2]+(double) (aritmetik_ortalama2) ;
			Preference_Matrix.sonuc_ortalamalari_circuled  [0][3]=Preference_Matrix.sonuc_ortalamalari_circuled  [0][3]+ (double)(standart_sapma1) ;
			Preference_Matrix.sonuc_ortalamalari_circuled  [1][3]=Preference_Matrix.sonuc_ortalamalari_circuled  [1][3]+ (double) (standart_sapma2 );
			Preference_Matrix.sonuc_ortalamalari_circuled  [0][4]=Preference_Matrix.sonuc_ortalamalari_circuled  [0][4]+ (double) (fark_ortalama) ;
			Preference_Matrix.sonuc_ortalamalari_circuled  [1][4]=Preference_Matrix.sonuc_ortalamalari_circuled  [1][4]+ (double)(sum_of_difference) ;
			Preference_Matrix.sonuc_ortalamalari_circuled  [0][5]=Preference_Matrix.sonuc_ortalamalari_circuled  [0][5]+ (double) (circuled_sum) ;
			
		for(int uu =0; uu< 2; uu++)
			for(int yy=0;yy<Preference_Matrix.sonuc_matis_boy ; yy++)
				Preference_Matrix.sonuc_circuled   [uu][yy] = Preference_Matrix.sonuc_ortalamalari_circuled  [uu][yy]/ Preference_Matrix.numClicks_circuled ;

		System.out.printf(" \n\nCIRCULED Sonuc: \n\n");
		for(int uu = 0; uu< Preference_Matrix.sonuc_matis_boy; uu++)
		{
			System.out.printf("( %.2f, %.2f)\n", Preference_Matrix.sonuc_circuled   [0][uu],Preference_Matrix.sonuc_circuled [1][uu]);
		}
